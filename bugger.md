...
![An image of the title screen with "tools" and a checkmark in the bottom left corner](title-screen.png)
...
![An image of BUGGER in the bottom left corner](bugger.png)
